...
export const RunHistoryScreen = memo<RunHistoryScreenProps>(({ visible, runHistory, onBack }) => {
          ...
          {!selectedRun ? (
                ...
                >
                  ...
                  <div className="run-preview">
                    <div className="preview-resources">
                      Hope: {run.finalResources.hope} | Health: {run.finalResources.health} |
            ...
            <div className="run-details">
              <div className="details-header">
                <button className="back-btn" onClick={() => setSelectedRun(null)}>
                  ← Back to List
                </button>
                  ...
                  <div className="details-section">
                    ...
                    <div className="achievements-list">
                      {selectedRun.achievementsUnlocked.map(achievementId => (
                        <span key={achievementId} className="achievement-item">
                          {achievementId}
                        </span>
                      ))}
                    </div>
