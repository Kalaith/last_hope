...
export const RunHistoryScreen = memo<RunHistoryScreenProps>(
  ({ visible, runHistory, onBack }) => {
    ...
    const calculateRunScore = (run: RunHistory): number => {
      ...
      score += Object.values(run.highestTrustLevels).reduce(
        (sum, trust) => sum + trust,
        0
      );
      return score;
          ...
          <div className="screen-header">
            ...
            <div className="history-controls">
              ...
              <div className="history-stats">
                ...
                <span>
                  Victories:{' '}
                  {runHistory.filter(r => r.endCondition === 'victory').length}
                </span>
              </div>
            </div>
          </div>
                  ...
                  >
                    <div className="run-header">
                      <span className="run-icon">
                        {getOutcomeIcon(run.endCondition)}
                      </span>
                      <span className="run-number">
                        Run #{runHistory.length - index}
                      </span>
                    ...
                    <div className="run-summary">
                      <div className="summary-item">
                        ...
                        <span className="value">
                          {formatEndCondition(run.endCondition)}
                        </span>
                      </div>
                      <div className="summary-item">
                      ...
                      <div className="summary-item">
                        ...
                        <span className="value">
                          {run.finalEcosystem.soilHealth}%
                        </span>
                      </div>
                      <div className="summary-item">
                        <span className="label">Score:</span>
                        <span className="value">
                          {calculateRunScore(run).toLocaleString()}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="run-preview">
                      <div className="preview-resources">
                        Hope: {run.finalResources.hope} | Health:{' '}
                        {run.finalResources.health} | Supplies:{' '}
                        {run.finalResources.supplies}
                      </div>
                      <div className="preview-ecosystem">
                        Plants: {run.finalEcosystem.totalPlants} | Diversity:{' '}
                        {run.finalEcosystem.plantDiversity} | Seeds Found:{' '}
                        {run.seedsDiscovered.length}
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="run-details">
                <div className="details-header">
                  ...
                  <div className="run-title">
                    <span className="run-icon">
                      {getOutcomeIcon(selectedRun.endCondition)}
                    </span>
                ...
                <div className="details-content">
                  <div className="details-section">
                    ...
                    <div className="stats-grid">
                      <div className="stat-item">
                        <span className="label">Outcome:</span>
                        <span
                          className={`value ${getOutcomeClass(selectedRun.endCondition)}`}
                        >
                      ...
                      <div className="stat-item">
                        ...
                        <span className="value">
                          {selectedRun.daysSurvived}
                        </span>
                      </div>
                      <div className="stat-item">
                        <span className="label">Choices Made:</span>
                        <span className="value">
                          {selectedRun.totalChoicesMade}
                        </span>
                      </div>
                      <div className="stat-item">
                        <span className="label">Final Score:</span>
                        <span className="value">
                          {calculateRunScore(selectedRun).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="details-section">
                    ...
                    <div className="resource-bars">
                      {Object.entries(selectedRun.finalResources).map(
                        ([resource, value]) => (
                  ...
                  <div className="details-section">
                    ...
                    <div className="ecosystem-stats">
                      <div className="eco-stat">
                        <span className="label">Soil Health:</span>
                        <span className="value">
                          {selectedRun.finalEcosystem.soilHealth}%
                        </span>
                      </div>
                      <div className="eco-stat">
                        <span className="label">Plant Diversity:</span>
                        <span className="value">
                          {selectedRun.finalEcosystem.plantDiversity} species
                        </span>
                      </div>
                      <div className="eco-stat">
                        <span className="label">Total Plants:</span>
                        <span className="value">
                          {selectedRun.finalEcosystem.totalPlants}
                        </span>
                      </div>
                      <div className="eco-stat">
                        <span className="label">Max Soil Achieved:</span>
                        <span className="value">
                          {selectedRun.maxSoilHealth}%
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="details-section">
                    ...
                    <div className="trust-levels">
                      {Object.entries(selectedRun.highestTrustLevels).map(
                        ([npcId, trust]) => (
                    ...
                    <div className="details-section">
                      ...
                      <div className="seeds-list">
                        {selectedRun.seedsDiscovered.map(seed => (
                          <span key={seed} className="seed-item">
                            {seed}
                          </span>
                        ))}
                      </div>
