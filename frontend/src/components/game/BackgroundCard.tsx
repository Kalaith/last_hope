...
const statDescriptions = {
  ...
  science:
    'Knowledge of restoration and environmental science. Helps with plant research and world healing.',
  leadership:
    'Ability to inspire and guide others. Improves relationship building and group decisions.',
...
export const BackgroundCard = memo<BackgroundCardProps>(({ background, isSelected, onSelect }) => {
  ...
  return (
    <Card className="background-card" onClick={handleSelect} selected={isSelected}>
      ...
      <div className="starting-stats">
        ...
        <div className="stats-grid">
          <StatPreview label="Hope" value={background.startingStats.hope} statKey="hope" />
          <StatPreview label="Science" value={background.startingStats.science} statKey="science" />
          <StatPreview
            label="Leadership"
            value={background.startingStats.leadership}
            statKey="leadership"
          />
          <StatPreview label="Empathy" value={background.startingStats.empathy} statKey="empathy" />
          <StatPreview
            label="Survival"
            value={background.startingStats.survival}
            statKey="survival"
          />
          <StatPreview label="Seeds" value={background.startingResources.seeds} statKey="seeds" />
        </div>
      </div>
    </Card>
  );
