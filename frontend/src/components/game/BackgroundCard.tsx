...
const statDescriptions = {
  ...
  empathy:
    'Understanding of human emotions. Strengthens bonds with other survivors and NPCs.',
  survival:
    'Practical skills for staying alive. Affects resource gathering and danger navigation.',
  seeds:
    "Precious genetic material that might restore the world. The key to humanity's future.",
};
