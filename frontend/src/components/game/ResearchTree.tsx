...
import { researchConstants, uiConstants } from '../../constants/gameConstants';
...
export const ResearchTree = memo<ResearchTreeProps>(({ gameState }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    'all' | 'agriculture' | 'ecology' | 'construction' | 'survival' | 'social'
  >('all');
  ...
  const activeBoosts = researchProgress
    ? researchSystem.getActiveBoosts(researchProgress.completedResearch)
    : {};
  const recommendations = researchProgress
    ? researchSystem.getResearchRecommendations(gameState, researchProgress)
    : [];

  const filteredResearch = researchTree.filter(
    ...
    <div className="research-tree">
      <div className="research-header">
        <Tooltip
          ...
          maxWidth={`${uiConstants.TOOLTIP_MAX_WIDTH_PX}px`}
        >
                      ...
                      <div style={{ marginBottom: '8px' }}>
                        ...
                        <div
                          style={{
                            fontSize: '0.9em',
                            color:
                              gameState.knowledge >= node.knowledgeRequired
