...
export const ResourcePressureIndicator = memo<ResourcePressureIndicatorProps>(({ gameState }) => {
  ...
  const shouldShow =
    pressures.some(p => p.pressure > 20) || activeEvents.length > 0 || warnings.length > 0;
          ...
          content={
            <div>
              ...
              <div style={{ fontSize: '0.9em', whiteSpace: 'pre-line' }}>
                Tracks resource scarcity and triggers dynamic events. • Higher pressure = more
                scarcity events • Active events drain resources daily • Critical warnings show
                immediate threats • Trends indicate if situation is improving Manage resources
            ...
            <Tooltip
              ...
              content={
                <div>
                  ...
                  <div style={{ marginBottom: '8px', fontSize: '0.9em' }}>{event.description}</div>
                  <div
                    style={{
                      fontSize: '0.85em',
