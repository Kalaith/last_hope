...
export const ResourcePressureIndicator = memo<ResourcePressureIndicatorProps>(
  ({ gameState }) => {
    ...
    const shouldShow =
      pressures.some(p => p.pressure > 20) ||
            ...
            content={
              <div>
                ...
                <div style={{ fontSize: '0.9em', whiteSpace: 'pre-line' }}>
                  Tracks resource scarcity and triggers dynamic events. • Higher
                  pressure = more scarcity events • Active events drain
                  resources daily • Critical warnings show immediate threats •
                  Trends indicate if situation is improving Manage resources
                  carefully to prevent crises!
                </div>
              </div>
            }
            position="bottom"
              ...
              <Tooltip
                ...
                content={
                  <div>
                    ...
                    >
                      • Daily drain: -{event.effects.dailyDrain}{' '}
                      {event.resource}
                      <br />• Severity: {event.severity}
                    </div>
                  </div>
                }
                position="top"
              ...
              >
                <div className="event-item" style={{ cursor: 'help' }}>
                  ...
                  <span
                    ...
                    style={{ color: getPressureColor(90) }}
                  >
                    {event.severity}
                  </span>
                </div>
                  ...
                  <div>
                    <div
                      style={{
                        fontWeight: 'bold',
                        marginBottom: '8px',
                        color: getPressureColor(pressure.pressure),
                      }}
                    >
                      {pressure.resource.charAt(0).toUpperCase() +
                        pressure.resource.slice(1)}{' '}
                      Pressure
                    </div>
                    ...
                    >
                      High pressure increases chance of scarcity events
              ...
              >
                <div className="pressure-item" style={{ cursor: 'help' }}>
                  <span className="pressure-icon">
                    {getPressureIcon(pressure.pressure)}
                  </span>
