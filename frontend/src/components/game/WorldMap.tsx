  ...
  const getZoneTooltip = (zone: MapZone, isCenter: boolean, gameState: GameState) => {
    ...
    return (
      <div>
        ...
        <div style={{ marginBottom: '8px', fontSize: '0.9em' }}>{info.description}</div>
        <div
          style={{
            marginBottom: '8px',
            fontSize: '0.9em',
          ...
          content={
            <div>
              ...
              <div style={{ fontSize: '0.9em', whiteSpace: 'pre-line' }}>
                This map shows your progress restoring the wasteland around your base camp. Each
                zone represents a different area of the ecosystem. As soil health improves,
                vegetation spreads outward from your central restoration efforts. Click on zones to
                see detailed information about their current state and what's needed for further
                restoration.
              </div>
            </div>
          }
