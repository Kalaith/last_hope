...
export const ChoicePreview = memo<ChoicePreviewProps>(
  ({ choice, currentState, canAfford }) => {
    ...
    const getProjectedStatus = (
      ...
      if (percentage <= 40 && (resource === 'hope' || resource === 'health'))
        return 'warning';
              ...
              <div key={index} className="projection-item">
                <div className="projection-resource">
                  <span className="resource-icon">
                    {getResourceIcon(projection.resource)}
                  </span>
                  <span className="resource-name">
                    {projection.resource.charAt(0).toUpperCase() +
                      projection.resource.slice(1)}
                  </span>
                </div>
        ...
        <div className="strategic-assessment">
          ...
          {riskLevel === 'medium' && (
            <div className="assessment-caution">
              ...
              <span>
                Proceed with caution - monitor your resources closely.
              </span>
            </div>
          )}
