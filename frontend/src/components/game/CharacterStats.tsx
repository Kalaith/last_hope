    ...
    <div className="character-panel">
      ...
      <div className="stats-grid">
        <div className="vital-stats">
          <ResourceStat label="Hope" value={safeHope} statKey="hope" />
