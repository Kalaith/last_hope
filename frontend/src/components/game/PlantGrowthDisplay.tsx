...
export const PlantGrowthDisplay = memo<PlantGrowthDisplayProps>(
  ({ plants, className = '' }) => {
        ...
        <div className={`plant-display empty ${className}`}>
          <div className="empty-state">
            ...
            <p className="empty-hint">
              Plant some seeds to begin ecosystem restoration
            </p>
          </div>
        </div>
      );
